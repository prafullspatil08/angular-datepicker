...
import { addDays, addMonths, eachDayOfInterval, endOfMonth, format, getDate, getDay, getMonth, getYear, isAfter, isBefore, isSameMonth, isToday, setDay, setMonth, setYear, startOfMonth, subDays, subMonths } from 'date-fns';
import { createDateRange, isSameDate } from './helpers';
...
@Component({
  selector: 'lib-angular-datepicker',
  templateUrl: './angular-datepicker.component.html',
  styleUrl: './angular-datepicker.component.scss',
  providers: [
    {
  ...
  implements ControlValueAccessor, OnInit, OnChanges
{
  ...
  currentOptions: DatepickerOptions | any = {
  ...
  private _range!: DateRange | undefined;
  ...
  private getValueToEmit(range: DateRange | any): DateRange | Date {
    if (!this.currentOptions.selectRange) {
